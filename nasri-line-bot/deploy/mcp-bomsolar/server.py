...
def bomsolar_smart_bom(
    ...
    try:
        ...
        if inv_brand and inv_sheet:
            ...
            if inv_brand == "ATMOCE":
                # Explicit user override takes precedence; MI-500 is default for ALL systems
                force_mi500 = bool(re.search(r"mi[\-\s]*500", lo))
                force_mi1250 = bool(re.search(r"mi[\-\s]*1250", lo))
                if force_mi1250:
                    # User explicitly requested MI-1250
                    ...
                    # Default: MI-500 for ALL ATMOCE (including ≥30kW), unless MI-1250 explicitly requested
                    ...
                    qty = explicit_panel_qty if explicit_panel_qty > 0 else math.ceil(system_kw / mi_kw)
