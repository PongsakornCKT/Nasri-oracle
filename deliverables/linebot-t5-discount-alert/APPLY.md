# T5 — Discount Alert Engine Guide (#B5)
...
**Grep Verified Line Numbers**: `lib/parse-quotation-spec.js:205`, `app.js:2319`  
**Business Decision (พี่พงเคาะ B5)**: แจ้งเตือนเมื่อส่วนลดทำมาร์จิ้นตกต่ำกว่า **10%** (ALERT ONLY — ห้าม BLOCK)  
...
1. **ระบบตรวจจับมาร์จิ้นสุทธิหลังหักส่วนลด (`discount-alert.js`)**:
...
```javascript
// T5 (#B5): Discount alert engine (P'Phong decision B5: alert when discount drops margin < 10%)
